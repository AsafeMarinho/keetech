...
def localizar_url(servico, estado, mod='55', ambiente=2):
    ...
    if servico in (WS_DFE_DISTRIBUICAO, WS_DOWNLOAD_NFE, WS_NFE_RECEPCAO_EVENTO_MANIFESTO):
        ws = AN
        url = ws[ambiente][servico]
...
AN = {
    NFE_AMBIENTE_PRODUCAO: {
        'servidor': '',
        WS_NFE_RECEPCAO_EVENTO: 'www.nfe.fazenda.gov.br/NFeRecepcaoEvento4/NFeRecepcaoEvento4.asmx?wsdl',
        WS_DFE_DISTRIBUICAO: 'www1.nfe.fazenda.gov.br/NFeDistribuicaoDFe/NFeDistribuicaoDFe.asmx?wsdl',
        WS_DOWNLOAD_NFE: 'www1.nfe.fazenda.gov.br/NFeDistribuicaoDFe/NFeDistribuicaoDFe.asmx?wsdl',
        WS_NFE_RECEPCAO_EVENTO_MANIFESTO: 'www.nfe.fazenda.gov.br/NFeRecepcaoEvento4/NFeRecepcaoEvento4.asmx?wsdl',
    },
    NFE_AMBIENTE_HOMOLOGACAO: {
        'servidor': 'hom.nfe.fazenda.gov.br',
...
UFAM = {
    ...
    NFCE_MODELO: {
        NFE_AMBIENTE_PRODUCAO: {
            ...
            WS_NFE_CANCELAMENTO: 'nfce-services/services/RecepcaoEvento4',
