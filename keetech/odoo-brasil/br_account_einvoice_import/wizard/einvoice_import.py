...
class BrAccountInvoiceImport(models.Model):
    ...
    def prepare_products(self, item):
        ...
        if inv_prod_vals['inv_prod_ean'] != None:
            if not pattern_int.match(inv_prod_vals['inv_prod_ean']):
                inv_prod_vals['inv_prod_ean'] = None
    ...
    def _prepare_edoc_vals(self, inv):
        ...
        inf = object.NFe.infNFe.infAdic if hasattr(object.NFe.infNFe, 'infAdic') else '',
